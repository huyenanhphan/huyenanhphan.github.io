...
const HeroSection = () => {
    ...
    const handleDownloadCV = () => {
        const cvPdfUrl = "/images/Anne Phan - Resume.pdf";
        ...
        <section id="home">
            <div className="grid grid-cols-1 lg:grid-cols-12">
                <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{duration:0.5}} className="col-span-7 place-self-center">
                    ...
                    <div>
                        <button onClick={handleHireMeClick} className="px-4 py-2 rounded-full sm:w-fit w-full mr-4 mb-3 bg-gradient-to-br from-violet-500 to-pink-500 hover:from-purple-600 hover:to-pink-600">Hire Me</button>
                        <button onClick={handleDownloadCV} className="px-5 py-2 rounded-full sm:w-fit w-full bg-gradient-to-br mb-4 from-violet-500 to-pink-500  hover:from-purple-600 hover:to-pink-600">Download CV</button>
                    </div>
                </motion.div>
